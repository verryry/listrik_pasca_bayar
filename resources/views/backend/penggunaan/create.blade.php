              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      <div class="basic-elements">
                          <form action="{{ route('penggunaan.store') }}" enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                              <div class="row">
                                  <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="number" name="meterawal" class="form-control" oninvalid="this.setCustomValidity('Tolong Isi Tahun')" oninput="setCustomValidity('')"  required>
                                      </div>
                                      <div class="form-group">
                                        <label>Meter Akhir</label>
                                        <input type="number" name="meterakhir" class="form-control" oninvalid="this.setCustomValidity('Tolong Isi Tahun')" oninput="setCustomValidity('')"  required>
                                      </div>
                                    </div>
                                  </div>
                              </div>
