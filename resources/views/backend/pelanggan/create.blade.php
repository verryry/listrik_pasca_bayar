                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <div class="form-group">
                                          <label>Nometer</label>
                                          <input type="text" name="nometer" class="form-control" oninvalid="this.setCustomValidity('Tolong Isi Kode Nometer')" oninput="setCustomValidity('')"  required>
                                      </div>
                                      <div class="form-group">
                                          <label>Nama</label>
                                          <input type="text" name="nama" class="form-control" oninvalid="this.setCustomValidity('Tolong Isi Nama Anda')" oninput="setCustomValidity('')"  required>
                                      </div>
                                      <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea style="height:auto !important;" class="form-control" rows="10" name="alamat" oninvalid="this.setCustomValidity('Tolong Isi Alamat Anda')" oninput="setCustomValidity('')"  required></textarea>
                                    </div>
                                  </div>
                                  <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_tarif" oninvalid="this.setCustomValidity('Tolong Isi Kode Tarif')" oninput="setCustomValidity('')"  required>
                                            <option selected="true" disabled="disabled">Pilih Kode Tarif</option>
